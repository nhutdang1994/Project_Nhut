...
<script type="text/javascript">
	$(document).ready(function() {
		$('#HoaDonTableContainer').jtable({
			title : 'Quản Lý Hóa Đơn',
			paging : true, //Enable paging
			pageSize : 20, 
			actions : {
				listAction : 'AdminHoaDon?action=list',
				createAction : 'AdminHoaDon?action=create',
				updateAction : 'AdminHoaDon?action=update',
				deleteAction : 'AdminHoaDon?action=delete',
			},
			fields : {
				idHD : {
					title : ' id',
		...
		$('#HoaDonTableContainer').jtable('load');
	});
</script>
<style>
.b {
...
<body>
	...
	<div style="text-align: center;">
		<div id="HoaDonTableContainer">
			<form action="AdminHoaDon" method="post" class="actions"></form>
		</div>
	</div>
	</div>
</div>
