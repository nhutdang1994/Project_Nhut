...
<script type="text/javascript">
	$(document).ready(function() {
		$('#CTSanPhamTableContainer').jtable({
			title : 'Quản Lý Sản Phẩm',
			paging : true, //Enable paging
			pageSize : 20, 
			actions : {
				listAction : 'AdminCTSP?action=list',
				createAction : 'AdminCTSP?action=create',
				updateAction : 'AdminCTSP?action=update',
				deleteAction : 'AdminCTSP?action=delete',
			},
			fields : {
				idct : {
					title : ' Id CT',
		...
		$('#CTSanPhamTableContainer').jtable('load');
	});
</script>
<style>
.b {
...
<body>
	...
	<div style="text-align: center;">
		<div id="CTSanPhamTableContainer">
			<form action="AdminCTSP" method="post" class="actions"></form>
		</div>
	</div>
</div>
</div>
