...
<script type="text/javascript">
	$(document).ready(function() {
		$('#SanPhamTableContainer').jtable({
			title : 'Quản Lý Sản Phẩm',
			paging : true, //Enable paging
			pageSize : 20, //Set page size (default: 10)      
			actions : {
				listAction : 'Controllers?action=list',
				createAction : 'Controllers?action=create',
				updateAction : 'Controllers?action=update',
				deleteAction : 'Controllers?action=delete',
			},
			fields : {
				id : {
					title : ' id',
		...
		$('#SanPhamTableContainer').jtable('load');
	});
</script>
<style>
.b {
...
<body>
	...
	<div style="text-align: center;">
		<div id="SanPhamTableContainer">
			<form action="Controller" method="post" class="actions"></form>
		</div>
	</div>
</div>
</div>
