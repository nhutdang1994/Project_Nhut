...
<link href="css/metro/blue/jtable.min.css" rel="stylesheet"
	type="text/css" />
...
<script type="text/javascript">
	$(document).ready(function() {
		$('#UserTableContainer').jtable({
			...
			pageSize : 20,
			actions : {
				listAction : 'AdminUser?action=list',
				createAction : 'AdminUser?action=create',
				updateAction : 'AdminUser?action=update',
				deleteAction : 'AdminUser?action=delete',
			},
			fields : {
				id : {
					title : ' id',
		...
		<div class="b">
			<div style="text-align: center;">
				<div id="UserTableContainer">
					<form action="AdminUser" method="post" class="actions"></form>
				</div>
			</div>
		</div>
	</div>
